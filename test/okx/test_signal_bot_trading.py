...
class TestSignalBotTradingApiClient(IsolatedAsyncioTestCase):
    ...
    async def test_post_api_v5_trading_bot_signal_create_signal(self, mock_post):
        result = await self.client.post_api_v5_trading_bot_signal_create_signal(
            "long short",
    ...
    async def test_get_api_v5_trading_bot_signal_signals(self, mock_get):
        result = await self.client.get_api_v5_trading_bot_signal_signals(
            "1"
        )
        self.assertIsInstance(result, dict)
        print(result)
    ...
    async def test_post_api_v5_trading_bot_signal_order_algo(self, mock_post):
        result = await self.client.post_api_v5_trading_bot_signal_order_algo(
            "2106674643045191680",
            "10",
            "100",
            "9",
    ...
    async def test_post_api_v5_trading_bot_signal_stop_order_algo(self, mock_post):
        result = await self.client.post_api_v5_trading_bot_signal_stop_order_algo(
            ["2106674643045191680"],
        )
        self.assertIsInstance(result, dict)
        print(result)
    ...
    async def test_post_api_v5_trading_bot_signal_margin_balance(self, mock_post):
        result = await self.client.post_api_v5_trading_bot_signal_margin_balance(
            "123456",
            "add",
            "10"
        )
    ...
    async def test_post_api_v5_trading_bot_signal_amend_tp_sl(self, mock_post):
        result = await self.client.post_api_v5_trading_bot_signal_amend_tp_sl(
            "637039348240277504",
            {
                "tpSlType": "pnl",
                "tpPct": "0.01",
    ...
    async def test_post_api_v5_trading_bot_signal_set_instruments(self, mock_post):
        result = await self.client.post_api_v5_trading_bot_signal_set_instruments(
            "637039348240277504",
            [
                "SHIB-USDT-SWAP",
                "ETH-USDT-SWAP"
    ...
    async def test_get_api_v5_trading_bot_signal_orders_algo_details(self, mock_get):
        result = await self.client.get_api_v5_trading_bot_signal_orders_algo_details(
            "637039348240277504",
            "contract"
        )
        self.assertIsInstance(result, dict)
    ...
    async def test_get_api_v5_trading_bot_signal_orders_algo_pending(self, mock_get):
        result = await self.client.get_api_v5_trading_bot_signal_orders_algo_pending(
    ...
    async def test_get_api_v5_trading_bot_signal_orders_algo_history(self, mock_get):
        result = await self.client.get_api_v5_trading_bot_signal_orders_algo_history(
            "637039348240277504"
        )
        self.assertIsInstance(result, dict)
        print(result)
    ...
    async def test_get_api_v5_trading_bot_signal_positions(self, mock_get):
        result = await self.client.get_api_v5_trading_bot_signal_positions(
            "623833708424069120",
            "contract"
        )
        self.assertIsInstance(result, dict)
    ...
    async def test_get_api_v5_trading_bot_signal_positions_history(self, mock_post):
        result = await self.client.get_api_v5_trading_bot_signal_positions_history(
            "1234",
        )
        self.assertIsInstance(result, dict)
        print(result)
    ...
    async def test_post_api_v5_trading_bot_signal_close_position(self, mock_post):
        result = await self.client.post_api_v5_trading_bot_signal_close_position(
            "448965992920907776",
            "BTC-USDT-SWAP",
        )
        self.assertIsInstance(result, dict)
    ...
    async def test_post_api_v5_trading_bot_signal_sub_orders(self, mock_post):
        result = await self.client.post_api_v5_trading_bot_signal_sub_order(
            "1222",
            "BTC-USDT-SWAP",
            "buy",
            "limit",
    ...
    async def test_post_api_v5_trading_bot_signal_cancel_sub_order(self, mock_post):
        result = await self.client.post_api_v5_trading_bot_signal_cancel_sub_order(
            "91664",
            "BTC-USDT-SWAP",
            "590908157585625111"
        )
    ...
    async def test_get_api_v5_trading_bot_signal_sub_orders(self, mock_post):
        result = await self.client.get_api_v5_trading_bot_signal_sub_orders(
            "623833708424069120",
            "contract",
    ...
    async def test_get_api_v5_trading_bot_signal_event_history(self, mock_get):
        result = await self.client.get_api_v5_trading_bot_signal_event_history(
            "623833708424069120",
        )
        self.assertIsInstance(result, dict)
        print(result)
