...
class AssetApi:
    ...
    async def get_v5_asset_settlement_record(
            self,
            category: str = "linear",
            **kwargs
    ):
    ...
    async def get_v5_asset_exchange_order_record(
            self,
            **kwargs
    ):
        """
    ...
    async def get_v5_asset_coin_query_info(
            self,
            coin: str | None = None
    ):
        """
    ...
    async def get_v5_asset_withdraw_withdrawable_amount(
            self,
            coin: str
    ):
        """
    ...
    async def get_v5_asset_transfer_query_inter_transfer_list(
            self,
            **kwargs
    ):
        """
    ...
    async def get_v5_asset_transfer_query_universal_transfer_list(
            self,
            **kwargs
    ):
        """
    ...
    # Deposit
    async def get_v5_asset_deposit_query_allowed_list(
            self,
            **kwargs
    ):
        """
    ...
    async def post_v5_asset_deposit_to_account(
            self,
            account_type: Literal["UNIFIED", "SPOT", "CONTRACT", "FUND"]
    ):
        """
        Set Deposit Account
    ...
    async def get_v5_asset_deposit_query_record(
            self,
            **kwargs
    ):
        """
    ...
    async def get_v5_asset_deposit_query_internal_record(
            self,
            **kwargs
    ):
        """
    ...
    # Withdraw
    async def get_v5_asset_withdraw_query_record(
            self,
            **kwargs
    ):
        """
    ...
    async def get_v5_asset_exchange_query_convert_history(
            self,
            **kwargs
    ):
        """
