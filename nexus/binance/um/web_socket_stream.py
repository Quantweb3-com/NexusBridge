...
from nexus.binance.constants import OrderType
...
async def continuous_kline(
    ...
    """
    stream_name = "{}_{}@continuousKline_{}".format(pair.lower(), contract_type, interval)
    if subscription:
        await self._subscribe(stream_name, _id)
    else:
        await self._unsubscribe(stream_name, _id)
