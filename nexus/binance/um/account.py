...
async def get_fapi_v1_commission_rate(
        self,
        symbol: str,
        **kwargs
):
...
async def get_fapi_v1_account_config(
        self,
        **kwargs
):
    """
...
async def get_fapi_v1_symbol_config(
        self,
        **kwargs
):
    """
...
async def get_fapi_v1_rate_limit_order(
        self,
        **kwargs
):
    """
...
async def get_fapi_v1_leverage_bracket(
        self,
        **kwargs
):
    """
...
async def get_fapi_v1_multi_assets_margin(
        self,
        **kwargs
):
    """
...
async def get_fapi_v1_position_side_dual(
        self,
        **kwargs
):
    """
...
async def get_fapi_v1_api_trading_status(
        self,
        **kwargs
):
    """
...
async def get_fapi_v1_income_asyn(
        self,
        start_time: int,
        end_time: int,
        **kwargs
...
async def get_fapi_v1_income_asyn_id(
        self,
        download_id: str,
        **kwargs
):
...
async def get_fapi_v1_order_asyn(
        self,
        start_time: int,
        end_time: int,
        **kwargs
...
async def get_fapi_v1_order_asyn_id(
        self,
        download_id: str,
        **kwargs
):
...
async def get_fapi_v1_trade_asyn(
        self,
        start_time: int,
        end_time: int,
        **kwargs
...
async def get_fapi_v1_trade_asyn_id(
        self,
        download_id: str,
        **kwargs
):
...
async def post_fapi_v1_fee_burn(
        self,
