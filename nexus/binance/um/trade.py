...
from nexus.binance.constants import OrderType, Side
...
async def post_fapi_v1_batch_order(
        self,
...
async def put_fapi_v1_batch_order(
        self,
        batch_orders: list[dict],
        **kwargs
):
...
async def get_fapi_v1_order_amendment(
        self,
        symbol: str,
        **kwargs
):
...
async def get_fapi_v1_all_orders(
        self,
        symbol: str,
        **kwargs):
    """
...
async def get_fapi_v1_open_orders(
        self,
        **kwargs):
    """
...
async def get_fapi_v1_open_order(
        self,
        symbol: str,
        **kwargs):
    """
...
async def post_fapi_v1_position_side_dual(
        self,
        dual_side_position: Literal["BOTH", "LONG", "SHORT"],
        **kwargs):
    """
...
async def post_fapi_v1_leverage(
        self,
        symbol: str,
        leverage: int,
        **kwargs):
...
async def post_fapi_v1_multi_assets_margin(
        self,
...
async def get_fapi_v1_position_margin_history(
        self,
        symbol: str,
        **kwargs
):
