...
async def post_dapi_v1_batch_order(
        self,
...
async def put_dapi_v1_batch_order(
        self,
        batch_orders: list[dict],
        **kwargs
):
...
async def get_dapi_v1_order_amendment(
        self,
        symbol: str,
        **kwargs
):
...
async def get_dapi_v1_all_orders(
        self,
        symbol: str,
        **kwargs):
    """
...
async def get_dapi_v1_open_orders(
        self,
        **kwargs):
    """
...
async def get_dapi_v1_open_order(
        self,
        symbol: str,
        **kwargs):
    """
...
async def post_dapi_v1_leverage(
        self,
        symbol: str,
        leverage: int,
        **kwargs):
...
async def get_dapi_v1_position_margin_history(
        self,
        symbol: str,
        **kwargs
):
