...
from nexus.binance.constants import Interval, ContractType
...
async def get_dapi_v1_historical_trades(
        self,
        symbol: str,
        **kwargs
):
...
async def get_dapi_v1_agg_trades(
        self,
        symbol: str,
        **kwargs
):
...
async def get_dapi_v1_premium_index(
        self,
        **kwargs
):
    """
...
async def get_dapi_v1_ticker_price(
        self,
        **kwargs
):
    """
...
async def get_dapi_v1_ticker_book_ticker(
        self,
        **kwargs
):
    """
