...
async def get_dapi_v1_commission_rate(
        self,
        symbol: str,
        **kwargs
):
...
async def get_dapi_v2_leverage_bracket(
        self,
        **kwargs
):
    """
...
async def get_dapi_v1_leverage_bracket(
        self,
        **kwargs
):
    """
...
async def get_dapi_v1_position_side_dual(
        self,
        **kwargs
):
    """
...
async def get_dapi_v1_income_asyn(
        self,
        start_time: int,
        end_time: int,
        **kwargs
...
async def get_dapi_v1_income_asyn_id(
        self,
        download_id: str,
        **kwargs
):
...
async def get_dapi_v1_order_asyn(
        self,
        start_time: int,
        end_time: int,
        **kwargs
...
async def get_dapi_v1_order_asyn_id(
        self,
        download_id: str,
        **kwargs
):
...
async def get_dapi_v1_trade_asyn(
        self,
        start_time: int,
        end_time: int,
        **kwargs
...
async def get_dapi_v1_trade_asyn_id(
        self,
        download_id: str,
        **kwargs
):
