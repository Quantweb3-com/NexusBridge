...
async def get_api_v3_historical_trades(
        self,
        symbol: str,
        **kwargs
):
...
async def get_api_v3_ui_klines(
        self,
        symbol: str,
        interval: Interval,
        **kwargs
...
async def get_api_v3_ticker_tradingDay(
        self,
