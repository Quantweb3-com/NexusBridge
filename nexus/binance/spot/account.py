...
async def get_api_v3_my_trades(
        self,
        symbol: str,
        **kwargs
):
...
async def get_api_v3_rate_limit_order(
        self,
        **kwargs
):
    """
...
async def get_api_v3_my_prevented_matches(
        self,
        symbol: str,
        **kwargs
):
...
async def get_api_v3_my_allocations(
        self,
        symbol: str,
        **kwargs
):
...
async def get_api_v3_account_commission(
        self,
        symbol: str
):
    """
