...
class CopyTradingApi:
    ...
    async def post_api_v5_copytrading_algo_order(
            self,
            sub_pos_id: str,
            **kwargs
    ):
    ...
    async def post_api_v5_copytrading_set_instruments(
            self,
            inst_id: str,
            **kwargs
    ):
    ...
    async def get_api_v5_copytrading_total_profit_sharing(self, inst_type: str | None = None):
        """
    ...
    async def get_api_v5_copytrading_unrealized_profit_sharing_details(self, inst_type: str | None = None):
        """
    ...
    async def get_api_v5_copytrading_preference_currency(self, unique_code: str, inst_type: str | None = None):
        """
    ...
    async def get_api_v5_copytrading_copy_traders(
            self,
            unique_code: str,
            **kwargs
    ):
