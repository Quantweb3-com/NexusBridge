...
class MarketDataApi:
    ...
    async def get_api_v5_market_books(
            self,
            inst_id: str,
            sz: str | None = None
    ):
    ...
    async def get_api_v5_market_books_full(
            self,
            inst_id: str,
            sz: str | None = None
    ):
    ...
    async def get_api_v5_market_history_trades(
            self,
            inst_id: str,
            **kwargs
    ):
    ...
    async def get_api_v5_market_option_instrument_family_trades(
            self,
            inst_family: str
    ):
        """
    ...
    async def get_api_v5_public_option_trades(
            self,
            **kwargs
    ):
        """
