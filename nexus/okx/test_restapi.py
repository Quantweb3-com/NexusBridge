...
class TestOkxApiClient(IsolatedAsyncioTestCase):
    ...
    def test__generate_signature(self):
        self.assertIsInstance(self.client._generate_signature('test'), str)

    def test__get_timestamp(self):
        self.assertIsInstance(self.client._get_timestamp(), str)
